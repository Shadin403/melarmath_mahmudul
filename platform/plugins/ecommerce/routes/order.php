...
use Botble\Marketplace\Http\Controllers\Fronts\OrderController;
...
AdminHelper::registerRoutes(function (): void {
    Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers', 'prefix' => 'ecommerce'], function (): void {
        Route::group(['prefix' => 'orders', 'as' => 'orders.'], function (): void {
            ...
            Route::get('print-order-details', [
                'as' => 'print-order-details',
                'uses' => 'OrderController@downloadOrderSummaryPdf',
                'permission' => 'orders.create',
            ]);

            Route::match(['GET', 'POST'], 'inside-dhaka', [
                'as' => 'inside-dhaka',
                'uses' => 'OrderController@insideDhaka',
                'permission' => 'orders.index',
            ]);

            Route::get('createInsideOfDhaka', [
                'as'    => 'createInsideOfDhaka',
                'uses' => 'OrderController@createInsideOfDhaka',
                'permission' => 'orders.create'
            ]);

            Route::post('saveDhakaArea', [
                'as'    => 'saveDhakaArea',
                'uses'  => 'OrderController@saveDhakaArea',
                'permission' => 'orders.create'
            ]);

            Route::get('editDhakaArea/{id}', [
                'as'    => 'editDhakaArea',
                'uses' => 'OrderController@editDhakaArea',
                'permission' => 'orders.create'
            ]);
            Route::put('updateDhakaArea/{id}', [
                'as'    => 'updateDhakaArea',
                'uses' => 'OrderController@updateDhakaArea',
                'permission' => 'orders.create'
            ]);
            Route::get('deleteDhakaArea/{id}', [
                'as'    => 'deleteDhakaArea',
                'uses' => 'OrderController@deleteDhakaArea',
                'permission' => 'orders.create'
            ]);

            Route::delete('deleteDhakaArea/{id}', [
                'as'    => 'deleteDhakaArea',
                'uses' => 'OrderController@deleteDhakaArea',
                'permission' => 'orders.create'
            ]);
