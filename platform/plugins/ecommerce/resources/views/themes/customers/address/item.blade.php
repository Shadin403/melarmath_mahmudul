<div class="col">
    ...
    <div class="bb-customer-card">
        ...
        <div class="bb-customer-card-body">
            <div class="bb-customer-card-info text-start">
                ...
                @if ($address->is_inside_dhaka)
                    <div class="info-item align-items-start">
                        <span class="label"><x-core::icon name="ti ti-building-community" /></span>
                        <span
                            class="value text-start">{{ Botble\Ecommerce\Models\GlobalOptionValue::find($address->is_inside_dhaka)?->option_value }}</span>
                    </div>
                @endif
                @if ($address->inside_dhaka)
                    <div class="info-item align-items-start">
                        <span class="label"><x-core::icon name="ti ti-map-pin" /></span>
                        <span
                            class="value text-start">{{ App\Models\DhakaArea::find($address->inside_dhaka)?->name }}</span>
                    </div>
                @endif
            </div>
        </div>
        <div class="bb-customer-card-footer">
            ...
            <x-core::form :url="route('customer.address.destroy', $address->id)" method="get"
