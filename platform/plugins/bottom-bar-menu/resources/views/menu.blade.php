<div class="footer-mobile" id="rh_footerMenu">
    <ul
    ...
    >
        <li>
            ...
            <li>
                <a class="trigger-mobile-menu" href="javascript:void(0)" data-menu="menu">
        ...
        @if (is_plugin_active('ecommerce'))
            <li>
                <a class="toggle--sidebar" href="{{ route('public.products') }}" data-menu="shop">
                    <i class="fi fi-rs-shop" style="margin-bottom: -3px;"></i>
                    <span>{{ __('Shop') }}</span>
                </a>
            </li>
