...
<head>
    ...
    <script src="https://kit.fontawesome.com/bfa81dbc98.js" crossorigin="anonymous"></script>
    ...
    {!! BaseHelper::googleFonts(
        'https://fonts.googleapis.com/css2?family=' .
            urlencode(theme_option('font_text', 'Lato')) .
            ':ital,wght@0,400;0,700;1,400;1,700&family=' .
            urlencode(theme_option('font_heading', 'Quicksand')) .
            ':wght@400;500;600;700&display=swap',
    ) !!}

    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-CLHZ4JFTB0"></script>
    <script>
...
<body {!! Theme::bodyAttributes() !!}>
    ...
    <div class="chatting_fix" id="chatting_popup" title="Live Chat" style="margin-block-end: 30px">
        <div class="chating_app">
            <img src="{{ asset('/') }}asset/helpdesk.gif" />
        </div>
    </div>
    {!! Theme::footer() !!}
