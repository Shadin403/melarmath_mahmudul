@php
    ...
    $layout =
        $layout && in_array($layout, array_keys(get_product_single_layouts())) ? $layout : 'product-right-sidebar';
    ...
    Theme::asset()
        ->container('footer')
        ->usePath()
        ->add('slick-js', 'js/plugins/slick.js', ['jquery']);
    ...
    Theme::asset()
        ->container('footer')
        ->usePath()
        ->add('magnific-popup-js', 'js/plugins/magnific-popup.js', ['jquery']);
...
<div class="product-detail accordion-detail">
    ...
    <div class="row mb-50 mt-30">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
            ...
            <div class="detail-gallery">
                ...
                <div class="slider-nav-thumbnails">
                    ...
                    @foreach ($productImages as $img)
                        <div><img src="{{ RvMedia::getImageUrl($img, 'product-thumb') }}" alt="{{ $product->name }}">
                        </div>
                    @endforeach
            ...
            {!! Theme::partial('social-share', [
                'url' => $product->url,
                'description' => strip_tags(SeoHelper::getDescription()),
            ]) !!}

            <a class="mail-to-friend font-sm color-grey"
                href="mailto:someone@example.com?subject={{ __('Buy :name', ['name' => $product->name]) }}&body={{ __('Buy this one: :link', ['link' => $product->url]) }}"><i
                    class="fi-rs-envelope"></i> {{ __('Email to a Friend') }}</a>
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="detail-info pr-30 pl-30">
                    ...
                    @if (EcommerceHelper::isReviewEnabled())
                        <a href="#Reviews" data-bb-toggle="scroll-to-review">
                            ...
                            <div class="product-rate-cover text-end">
                                ...
                                <span
                                    class="font-small ml-5 text-muted">({{ __(':count reviews', ['count' => $product->reviews_count]) }})</span>
                ...
                <h4 style="color: #5a97fa;" id="variation_product_name">{!! highlightProductText($product->sub_title) !!}</h4>
                ...
                <div class="short-desc mb-30">
                    ...
                    @if (is_plugin_active('marketplace') && $product->store_id)
                        <p><span class="d-inline-block me-1">{{ __('Sold By') }}:</span> <a
                                href="{{ $product->store->url }}"><strong>{!! BaseHelper::clean($product->store->name) !!}</strong></a></p>
                    @endif
                ...
                <form class="add-to-cart-form" method="POST" action="{{ route('public.ajax.cart.store') }}">
                    ...
                    <div class="detail-extralink mb-30 single-line-actions" style="margin-top: 33px;">
                        ...
                        <div class="product-extra-link2 @if (EcommerceHelper::isQuickBuyButtonEnabled()) has-buy-now-button @endif">
                            ...
                            @if (EcommerceHelper::isCartEnabled())
                                ...
                                <button type="submit"
                                    ...
                                    <i class="fi-rs-shopping-cart"></i>{{ __('Add to cart') }}

                                </button>

                                @if (EcommerceHelper::isQuickBuyButtonEnabled())
                                    <button
                                        class="button button-buy-now ms-2 @if ($product->isOutOfStock()) btn-disabled @endif"
                            ...
                            @if (EcommerceHelper::isWishlistEnabled())
                                <a aria-label="{{ __('Add To Wishlist') }}"
                                    class="action-btn hover-up js-add-to-wishlist-button"
                                    data-url="{{ route('public.wishlist.add', $product->id) }}" href="#">
                ...
                <div class="font-xs">
                    ...
                    <ul class="mr-50 float-start">
                        ...
                        <li class="mb-5 @if (!$product->sku) d-none @endif" id="product-sku">
                            ...
                            <span class="d-inline-block me-1">{{ __('SKU') }}:</span> <span
                                class="sku-text">{{ $product->sku }}</span>
                        ...
                        @if ($product->categories->isNotEmpty())
                            ...
                            <li class="mb-5">
                                ...
                                @foreach ($product->categories as $category)
                                    <a href="{{ $category->url }}"
                                        title="{{ $category->name }}">{!! BaseHelper::clean($category->name) !!}</a>
                                    @if (!$loop->last)
                                        ,
                                    @endif
                                @endforeach
                ...
                @if (EcommerceHelper::isProductSpecificationEnabled() &&
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" id="specification-tab" data-bs-toggle="tab"
                            href="#tab-specification">{{ __('Specification') }}</a>
                ...
                @if (EcommerceHelper::isReviewEnabled())
                    <li class="nav-item">
                        ...
                        <a class="nav-link" id="Reviews-tab" data-bs-toggle="tab"
                            href="#Reviews">{{ __('Reviews') }} ({{ $product->reviews_count }})</a>
            ...
            <div class="tab-content shop_info_tab entry-main-content">
                ...
                <div class="tab-pane fade show active" id="Description">
                    ...
                    <div id="description-wrapper">
                        ...
                        <div class="ck-content" id="product-description-content">

                            {!! BaseHelper::clean($product->content) !!}

                        </div>

                        <button id="toggle-description-btn" class="description-toggle-btn">আরো দেখুন...</button>
                ...
                @if (is_plugin_active('marketplace') && $product->store_id && $product->store->id)
                    ...
                    <div class="tab-pane fade" id="tab-vendor">
                        ...
                        <div class="vendor-logo d-flex mb-30">
                            ...
                            <img src="{{ RvMedia::getImageUrl($product->store->logo, null, false, RvMedia::getDefaultImage()) }}"
                                    ...
                                    <div class="product-rate-cover text-end">
                                        ...
                                        <div class="product-rate d-inline-block">
                                            ...
                                            <div class="product-rating"
                                                style="width: {{ $reviews->reviews_avg * 20 }}%"></div>

                                        </div>

                                        <span class="font-small ml-5 text-muted">
                                            ({{ __(':count reviews', ['count' => $reviews->reviews_count]) }})</span>
                        ...
                        <ul class="contact-infor mb-50">
                            ...
                            @if (!MarketplaceHelper::hideStoreAddress() && $product->store->full_address)
                                <li>
                                    ...
                                    <img src="{{ Theme::asset()->url('imgs/theme/icons/icon-location.svg') }}"
                                        alt="{{ __('Address') }}" />
                            ...
                            @if (!MarketplaceHelper::hideStorePhoneNumber() && $product->store->phone)
                                <li>
                                    ...
                                    <img src="{{ Theme::asset()->url('/imgs/theme/icons/icon-contact.svg') }}"
                                        alt="{{ __('Contact Seller') }}" />
    ...
    @if ($crossSellProducts->isNotEmpty())
        <div class="mt-60">
            ...
            @include(Theme::getThemeNamespace() . '::views.ecommerce.includes.product-items-loop', [
    ...
    @if ($relatedProducts->isNotEmpty())
        <div class="mt-60">
            ...
            @include(Theme::getThemeNamespace() . '::views.ecommerce.includes.product-items-loop-2', [
...
<style>
    ...
    .description-toggle-btn.see-less-mode {
    ...
    .description-toggle-btn.see-less-mode:hover {
    ...
    .single-line-actions {
        ...
        /* মোবাইলে নতুন লাইনে যাবে */

    }



    .single-line-actions .detail-qty {
    ...
    .single-line-actions .product-extra-link2 {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const contentDiv = document.getElementById('product-description-content');
        ...
        const fullContentText = contentDiv.textContent || contentDiv.innerText;

        const collapsedHeight = '210px';



        if (fullContentText.length <= 200) {
        ...
        contentDiv.style.maxHeight = collapsedHeight;

        contentDiv.style.overflow = 'hidden';

        contentDiv.style.transition = 'max-height 0.6s cubic-bezier(0.4, 0, 0.2, 1)';
        ...
        toggleBtn.addEventListener('click', function(event) {
            ...
            const isExpanded = toggleBtn.innerText === 'সংক্ষিপ্ত করুন.';
            ...
            if (isExpanded) {
                ...
                toggleBtn.classList.remove('see-less-mode');

                toggleBtn.innerText = 'আরো দেখুন...';



                // Collapse হওয়ার পর smooth scroll to top of description
                ...
                toggleBtn.innerText = 'সংক্ষিপ্ত করুন.';

                toggleBtn.classList.add('see-less-mode');



                contentDiv.addEventListener('transitionend', function() {

                    if (toggleBtn.innerText === 'সংক্ষিপ্ত করুন.') {
