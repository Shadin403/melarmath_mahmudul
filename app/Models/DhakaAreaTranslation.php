...
class DhakaAreaTranslation extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'ec_dhaka_area_translations';
    ...
    {
        return $this->getAttribute('lang_code') . '_' . $this->getAttribute('ec_dhaka_area_id');
    }
    ...
    protected function setKeysForSaveQuery($query)
    {
        $query->where('lang_code', $this->getAttribute('lang_code'))
            ->where('ec_dhaka_area_id', $this->getAttribute('ec_dhaka_area_id'));
    ...
    {
        return ['lang_code', 'ec_dhaka_area_id'];
    }
    ...
    public function setAttribute($key, $value)
    {
        ...
        if (in_array($key, ['lang_code', 'ec_dhaka_area_id'])) {
